...
Feature: Bet Information
  ...
  @BITest3
  Scenario: Test Case 3: Checking The Bet Information Of The Multiple Bets
    When I Bet "In Multiple Betting Options Until Round Complete"
    And I Click "The My Bets Button In The Game Table"
    And I Click "The Details Button Within The My Bets Modal In The Game Table"
    Then I Verify The Bet Information Of "The Multiple Bets"