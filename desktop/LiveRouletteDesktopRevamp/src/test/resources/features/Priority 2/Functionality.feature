...
Feature: Functionality
  ...
  @FTTest58
  Scenario: Test Case 58: Checking The Functionality Of The Game Statistics Panel In The Game Table
    When I Enter Any Game Table
    And I Click "The Close Button Within The Game Statistics Panel In The Game Table"
    Then I Verify The Functionality Of "The Close Button Within The Game Statistics Panel In The Game Table"
    When I Click "The Open Button Within The Game Statistics Panel In The Game Table"
    Then I Verify The Functionality Of "The Open Button Within The Game Statistics Panel In The Game Table"

  @FTTest59To60
  Scenario: Test Case 59 To 60: Checking The Functionality Of The Hot And Cold Numbers Panel In The Game Table
    # Test Case 59
    When I Enter Any Game Table
    ...
    # Test Case 60
    And I Click "The Open Information Button Within The Hot And Cold Numbers Panel In The Game Table"
    Then I Verify The Functionality Of "The Open Information Button Within The Hot And Cold Numbers Panel In The Game Table"
    When I Click "The Close Information Button Within The Hot And Cold Numbers Panel In The Game Table"
    Then I Verify The Functionality Of "The Close Information Button Within The Hot And Cold Numbers Panel In The Game Table"
  ...
  @FTTest61To62
  Scenario: Test Case 61 To 62: Checking The Functionality Of The Edit Chips Button In The Game Table
    # Test Case 61
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
  ...
  @FTTest63To64
  Scenario: Test Case 63 To 64: Checking The Functionality Of The Arrow Buttons Within The Chip Settings Panel In The Game Table
    # Test Case 63
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Edit Chips Button In The Game Table"
  ...
  @FTTest65
  Scenario: Test Case 65: Checking The Functionality Of The Remove Chip Button Within The Chip Settings Panel In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Edit Chips Button In The Game Table"
  ...
  @FTTest66
  Scenario: Test Case 66: Checking The Functionality Of The Add Chip Button Within The Chip Settings Panel In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Edit Chips Button In The Game Table"
    And I Click "The Remove Chip Button Within The Chip Settings Panel In The Game Table"
  ...
  @FTTest67
  Scenario: Test Case 67: Checking The Functionality Of The Save Button Within The Chip Settings Panel In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Edit Chips Button In The Game Table"
    And I Click "The Remove Chip Button Within The Chip Settings Panel In The Game Table"
  ...
  @FTTest68
  Scenario: Test Case 68: Checking The Functionality Of Each Chip Within The Default Chips In The Game Table
    When I Enter Any Game Table
  ...
  @FTTest69To70
  Scenario: Test Case 69 To 70: Checking The Functionality Of The Undo Button In The Game Table
    # Test Case 69
    When I Enter Any Game Table
  ...
  @FTTest71
  Scenario: Test Case 71: Checking The Functionality Of The Cancel Button In The Game Table
    When I Enter Any Game Table
    And I Bet "Four Or More In Any Betting Options"
  ...
  @FTTest72
  Scenario: Test Case 72: Checking The Functionality Of The Double Button In The Game Table
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
  ...
  @FTTest73To74
  Scenario: Test Case 73 To 74: Checking The Functionality Of The Confirm Button In The Game Table
    # Test Case 73
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    And I Click "The Confirm Button In The Game Table"
  ...
  @FTTest75
  Scenario: Test Case 75: Checking The Functionality Of The Top Up Confirm Button In The Game Table
    When I Enter Any Game Table
  ...
  @FTTest76
  Scenario: Test Case 76: Checking The Functionality Of The ReBet Button In The Game Table
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    And I Click "The Confirm Button In The Game Table"
    And I Wait "Until The Round Is Settled In The Game Table"
  ...
  @FTTest77
  Scenario: Test Case 77: Checking The Functionality Of Any Betting Option In The Game Table
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    Then I Verify The Functionality Of "Any Betting Option In The Game Table"

  @FTTest78
  Scenario: Test Case 78: Checking The Functionality Of All Betting Option In The Game Table
    When I Enter Any Game Table
    And I Bet "In Each Betting Option"
    Then I Verify The Functionality Of "All Betting Option In The Game Table"

  @FTTest79
  Scenario: Test Case 79: Checking The Behavior Of The Betting Option In The Game Table When There Is A Placed Bet
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
  ...
  @FTTest80
  Scenario: Test Case 80: Checking The Functionality Of The Confirm Button Within The Confirmation Modal In The Game Table
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
  ...
  @FTTest81
  Scenario: Test Case 81: Checking The Functionality Of The Not Now Button Within The Confirmation Modal In The Game Table
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    And I Wait "Until The Betting Timer Is Less Than 10 Seconds In The Game Table"
  ...
  @FTTest82
  Scenario: Test Case 82: Checking The Functionality Of The Result Panel After The Player Wins A Round
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    And I Click "The Confirm Button In The Game Table"
  ...
  @FTTest83
  Scenario: Test Case 83: Checking The Functionality Of The Result Panel After The Player Loses A Round
    When I Enter Any Game Table
    And I Bet "In Any Betting Option"
    And I Click "The Confirm Button In The Game Table"
