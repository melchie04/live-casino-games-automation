...
public class VerifySteps {
    ...
    public void iVerifyTheUI(String step) {
        switch (step) {
            case "The Live Roulette Desktop Revamp Thumbnail" -> UITest1.verify();
            case "The Live Roulette Desktop Revamp After Entering The Game Lobby" -> UITest2.verify();
            case "The Live Roulette Desktop Revamp After Entering The Game Table" -> UITest3.verify();
            case "The Live Roulette Desktop Revamp During Betting Phase" -> UITest4.verify();
            case "The Live Roulette Desktop Revamp During Dealing Phase" -> UITest5.verify();
            case "The Live Roulette Desktop Revamp During Result Phase" -> UITest6.verify();
        }
    }
    ...
    public void iVerifyTheBehaviorOf(String step) {
        switch (step) {
            ...
            case "The Number Of Deals And The Counters In The Game Lobby After The Round Is Settled",
                 "The Number Of Deals And The Counters In The Game Lobby Matches The Counters In The Game Table" -> BHTest16.verify();
            ...
            case "The Total Counter Within The Jump Table Window In The Game Table After The Round Is Settled",
                 "The Counters Within The Jump Table Window In The Game Table Matches The Counters In The Game Lobby" -> BHTest34.verify();
    ...
    public void iVerifyTheFunctionalityOf(String step) {
        switch (step) {
            ...
            case "The Close Button Within The Game Statistics Panel In The Game Table",
                 "The Open Button Within The Game Statistics Panel In The Game Table" -> FTTest58.verify();
            ...
            case "The Open Information Button Within The Hot And Cold Numbers Panel In The Game Table",
                 "The Close Information Button Within The Hot And Cold Numbers Panel In The Game Table" -> FTTest60.verify();
            // ? Tool Bar of the Game Table Page
            case "The Edit Chips Button In The Game Table" -> FTTest61.verify();
            case "The Close Button Within The Chip Settings Panel In The Game Table" -> FTTest62.verify();
            case "The Next Arrow Button Within The Chip Settings Panel In The Game Table" -> FTTest63.verify();
            case "The Previous Arrow Button Within The Chip Settings Panel In The Game Table" -> FTTest64.verify();
            case "The Remove Chip Button Within The Chip Settings Panel In The Game Table" -> FTTest65.verify();
            case "The Add Chip Button Within The Chip Settings Panel In The Game Table" -> FTTest66.verify();
            case "The Save Button Within The Chip Settings Panel In The Game Table" -> FTTest67.verify();
            case "Each Chip Within The Default Chips In The Game Table" -> FTTest68.verify();
            case "The Undo Button In The Game Table" -> FTTest69.verify();
            case "The Undo Button In The Game Table After Pressing And Holding" -> FTTest70.verify();
            case "The Cancel Button In The Game Table" -> FTTest71.verify();
            case "The Double Button In The Game Table" -> FTTest72.verify();
            case "The Confirm Button In The Game Table" -> FTTest73.verify();
            case "The Confirm Button In The Game Table When There Is A Confirmed Bet" -> FTTest74.verify();
            case "The Top Up Confirm Button In The Game Table" -> FTTest75.verify();
            case "The ReBet Button In The Game Table" -> FTTest76.verify();
            // ? Betting Option Panel of the Game Table Page
            case "Any Betting Option In The Game Table" -> FTTest77.verify();
            case "All Betting Option In The Game Table" -> FTTest78.verify();
            case "The Betting Option In The Game Table When There Is A Placed Bet" -> FTTest79.verify();
            case "The Confirm Button Within The Confirmation Modal In The Game Table" -> FTTest80.verify();
            case "The Not Now Button Within The Confirmation Modal In The Game Table" -> FTTest81.verify();
            case "The Result Panel After The Player Wins A Round" -> FTTest82.verify();
            case "The Result Panel After The Player Loses A Round" -> FTTest83.verify();
        }
    }
    ...
    public void iVerifyThePayoutCalculationOf(String step) {
        switch (step) {
            case "The Red Result" -> Payout.verify(1, step);
            case "The Black Result" -> Payout.verify(2, step);
            case "The Even Result" -> Payout.verify(3, step);
            case "The Odd Result" -> Payout.verify(4, step);
            case "The Low Result" -> Payout.verify(5, step);
            case "The High Result" -> Payout.verify(6, step);
            case "The 1st Dozen Result" -> Payout.verify(7, step);
            case "The 2nd Dozen Result" -> Payout.verify(8, step);
            case "The 3rd Dozen Result" -> Payout.verify(9, step);
            case "The 1st Column Result" -> Payout.verify(10, step);
            case "The 2nd Column Result" -> Payout.verify(11, step);
            case "The 3rd Column Result" -> Payout.verify(12, step);
            case "The Straight Up Result" -> Payout.verify(13, step);
            case "The Split Result" -> Payout.verify(14, step);
            case "The Street Result" -> Payout.verify(15, step);
            case "The Corner Result" -> Payout.verify(16, step);
            case "The Six Line Result" -> Payout.verify(17, step);
            case "The Zero Section Result" -> Payout.verify(18, step);
            case "The Zero Corner Result" -> Payout.verify(19, step);
        }
    }
