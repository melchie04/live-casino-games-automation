...
Feature: Functionality
  ...
  @FTTest57
  Scenario: Test Case 57: Checking The Functionality Of The Commission / Non-Commission Button In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Commission / Non-Commission Button In The Game Table"
    Then I Verify The Functionality Of "The Commission / Non-Commission Button In The Game Table After Clicked"
    When I Click "The Commission / Non-Commission Button In The Game Table"
    Then I Verify The Functionality Of "The Commission / Non-Commission Button In The Game Table After Re-clicked"

  @FTTest58
  Scenario: Test Case 58: Checking The Functionality Of The Player Prediction Button In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Player Prediction Button In The Game Table"
    Then I Verify The Functionality Of "The Player Prediction Button In The Game Table"

  @FTTest59
  Scenario: Test Case 59: Checking The Functionality Of The Banker Prediction Button In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Banker Prediction Button In The Game Table"
    Then I Verify The Functionality Of "The Banker Prediction Button In The Game Table"
