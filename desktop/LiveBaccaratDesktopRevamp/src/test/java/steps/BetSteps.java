...
public class BetSteps extends Methods {
    ...
    public void iBet(String step) {
        switch (step) {
            ...
            case "In Any Betting Option Until Tie" -> betInAnyBettingOptionUntilTie();
    ...
    private static void betInAnyBettingOptionUntilWin() {
        ...
        } while (isError || !Condition.isPlayerWin(Variables.roundResult));
        WaitHandler.wait(5);
    }
    ...
    private static void betInAnyBettingOptionUntilTie() {
        boolean isError = true;
        do {
            try {
                waitBettingPhase(20, false);
        ...
        } while (isError || !Condition.isTieWin(Variables.roundResult));
        WaitHandler.wait(5);
    }
