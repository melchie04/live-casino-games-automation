...
public class ClickSteps {
    ...
    public void iClick(String step) {
        switch (step) {
            ...
            case "The Close Button Within The Game Results Panel In The Game Table" -> EventHandler.click(XPath.GameTable.GameResults.Close);
            case "The Open Button Within The Game Results Panel In The Game Table" -> EventHandler.click(XPath.GameTable.GameResults.Open);
