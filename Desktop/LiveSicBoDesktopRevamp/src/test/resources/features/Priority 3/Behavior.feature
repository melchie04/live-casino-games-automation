...
Feature: Behavior
  ...
  Scenario: Test Case 16: Checking The Behavior Of The Number Of Deals And The Counters In The Game Lobby
    ...
    And I Check "For The Latest Results In The Game Lobby"
  ...
  @BHTest34
  Scenario: Test Case 34: Checking The Behavior Of The Latest Results Within The Jump Table Window In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Jump Table Button In The Game Table"
    And I Check "For The Latest Results Within The Jump Table Window In The Game Table"
    And I Click "The Close Button Within The Jump Table Window In The Game Table"
    And I Click "The Back Button In The Game Table"
    Then I Verify The Behavior Of "The Latest Results Within The Jump Table Window In The Game Table Matches The Counters In The Game Lobby"
