    ...
    public static void verify() {
        ...
        CustomAssert.assertTrue(
                ...
                ConditionHandler.isUrlContains("/gameLobby", 15) ||
                        ConditionHandler.isUrlContains("/baccaratDesktop", 15),
                "The Live Baccarat Desktop Revamp is launched.",
                "The Live Baccarat Desktop Revamp is not launched."
        );
        ...
        VerificationHandler.verifyIfDisplayed(
                "UI Test 2",
                XPath.GameLobby.RoadMaps.RoadMapFullscreen,
                5
        );

        for (Locator roadMap : XPath.GameLobby.RoadMaps.AllMaps)
            VerificationHandler.verifyIfDisplayed(
                    "UI Test 2",
                    roadMap,
                    5
