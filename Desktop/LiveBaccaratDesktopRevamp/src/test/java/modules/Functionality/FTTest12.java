...
public class FTTest12 {
    ...
    public static void verify() {
        ...
        if (Variables.hasSettledRounds) {
            ...
            VerificationHandler.verifyIfDisplayed(
                    "FT Test 12",
                    XPath.GameLobby.BetDetails.PlayerCards,
                    5
            );

            VerificationHandler.verifyIfDisplayed(
                    "FT Test 12",
                    XPath.GameLobby.BetDetails.PlayerTotalPoints,
                    5
            );

            VerificationHandler.verifyIfDisplayed(
                    "FT Test 12",
                    XPath.GameLobby.BetDetails.BankerCards,
                    5
            );

            VerificationHandler.verifyIfDisplayed(
                    "FT Test 12",
                    XPath.GameLobby.BetDetails.BankerTotalPoints,
                    5
            );
