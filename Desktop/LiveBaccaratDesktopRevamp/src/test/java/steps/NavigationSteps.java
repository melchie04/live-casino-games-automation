...
public class NavigationSteps {
    ...
    public void iEnterTheLiveBaccaratDesktopRevampThumbnail() {
        Navigator navigator = () -> {
            Variables.productName = "Baccarat";
            // Go to game lobby page
            if (ConditionHandler.isDisplayed(XPath.LiveCasino.LiveBaccaratDesktopRevamp, 5)) {
                EventHandler.click(XPath.LiveCasino.LiveBaccaratDesktopRevamp);
        ...
        retrySteps(navigator, "Enter The Live Baccarat Desktop Revamp Thumbnail.");
    }
    ...
    public void iEnterAnyTable() {
        ...
        Navigator navigator = () -> {
            ...
            WaitHandler.waitUrlContains("/baccaratDesktop", 5);
