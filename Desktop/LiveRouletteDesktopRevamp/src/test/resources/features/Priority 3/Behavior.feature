...
Feature: Behavior
  ...
  @BHTest16
  Scenario: Test Case 16: Checking The Behavior Of The Number Of Deals And The Counters In The Game Lobby
    When I Check "For The Table Name In The Game Lobby"
    And I Check "For The Number Of Deals In The Game Lobby"
    And I Wait "Until The Round Is Settled In The Game Lobby"
    Then I Verify The Behavior Of "The Number Of Deals And The Counters In The Game Lobby After The Round Is Settled"
    When I Check "For The Counters In The Game Lobby"
    And I Enter The Selected Game Table
    And I Click "The Jump Table Button In The Game Table"
    Then I Verify The Behavior Of "The Number Of Deals And The Counters In The Game Lobby Matches The Counters In The Game Table"
  ...
  @BHTest34
  Scenario: Test Case 34: Checking The Behavior Of The Counters Within The Jump Table Window In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    And I Click "The Jump Table Button In The Game Table"
    And I Check "For The Counters Within The Jump Table Window In The Game Table"
    And I Wait "Until The Round Is Settled In The Game Table"
    Then I Verify The Behavior Of "The Total Counter Within The Jump Table Window In The Game Table After The Round Is Settled"
    When I Click "The Close Button Within The Jump Table Window In The Game Table"
    And I Click "The Back Button In The Game Table"
    Then I Verify The Behavior Of "The Counters Within The Jump Table Window In The Game Table Matches The Counters In The Game Lobby"

  @BHTest35
  Scenario: Test Case 35: Checking The Behavior Of The Betting Timer In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Betting Phase In The Game Table"
    Then I Verify The Behavior Of "The Betting Timer In The Game Table"

  @BHTest36
  Scenario: Test Case 36: Checking The Behavior Of The Dealing Text In The Game Table
    When I Enter Any Game Table
  ...
  @BHTest37
  Scenario: Test Case 37: Checking The Behavior Of The Result Panel In The Game Table
    When I Enter Any Game Table
    And I Wait "Until The Game Is Dealing Phase In The Game Table"
    Then I Verify The Behavior Of "The Result Panel In The Game Table"
