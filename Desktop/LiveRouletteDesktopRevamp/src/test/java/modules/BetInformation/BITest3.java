...
public class BITest3 {
    ...
    private static double getExpectedPayout() {
        ...
        expectedWinLoss += getPayout(35, Condition.isStraightUpWin(Variables.roundResult, 4), Variables.MULTIPLE_BETTING_CHIPS[0]);
        expectedWinLoss += getPayout(5, Condition.isPosBetWin(Variables.roundResult, Variables.SIX_LINE_LIST[0]), Variables.MULTIPLE_BETTING_CHIPS[1]);
        expectedWinLoss += getPayout(17, Condition.isPosBetWin(Variables.roundResult, Variables.SPLIT_LIST[3]), Variables.MULTIPLE_BETTING_CHIPS[2]);
        expectedWinLoss += getPayout(11, Condition.isPosBetWin(Variables.roundResult, Variables.STREET_LIST[1]), Variables.MULTIPLE_BETTING_CHIPS[3]);
        expectedWinLoss += getPayout(1, Condition.isBlackWin(Variables.roundResult), Variables.MULTIPLE_BETTING_CHIPS[4]);
        expectedWinLoss += getPayout(1, Condition.isEvenWin(Variables.roundResult), Variables.MULTIPLE_BETTING_CHIPS[5]);
        expectedWinLoss += getPayout(1, Condition.isHighWin(Variables.roundResult), Variables.MULTIPLE_BETTING_CHIPS[6]);
        expectedWinLoss += getPayout(2, Condition.is1stDozenWin(Variables.roundResult), Variables.MULTIPLE_BETTING_CHIPS[7]);
        expectedWinLoss += getPayout(2, Condition.is1stColumnWin(Variables.roundResult), Variables.MULTIPLE_BETTING_CHIPS[8]);
