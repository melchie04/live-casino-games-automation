...
public class CheckSteps {
    ...
    public void iCheck(String step) {
        switch (step) {
            ...
            case "For The Counters In The Game Lobby" -> {
                Variables.allCounters = GetHandler.getIntArray(XPath.GameLobby.ResultHistory.getAllCounters(Variables.tableName));
                System.out.println();
                Printer.printInfo("All Counters: " + Helper.toString(Variables.allCounters));
            }
            // ?  Game Table Page
            ...
            case "For The Counters Within The Jump Table Window In The Game Table" -> {
                WaitHandler.wait(3);
