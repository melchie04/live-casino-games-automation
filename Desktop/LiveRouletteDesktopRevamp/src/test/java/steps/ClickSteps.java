...
public class ClickSteps {
    ...
    public void iClick(String step) {
        switch (step) {
            ...
            case "The Other Live Game Tab Within The Side Menu In The Game Lobby" -> EventHandler.click(XPath.GameLobby.SideMenu.Baccarat);
            ...
            case "The Hide / Show Tool Bar Button In The Game Table" -> EventHandler.click(XPath.GameTable.Content.HideShowToolBar);
            case "The Close Button Within The Game Statistics Panel In The Game Table" -> EventHandler.click(XPath.GameTable.GameStatistics.Close);
            case "The Open Button Within The Game Statistics Panel In The Game Table" -> EventHandler.click(XPath.GameTable.GameStatistics.Open);
            case "The Close Button Within The Hot And Cold Numbers Panel In The Game Table" -> EventHandler.click(XPath.GameTable.HotColdNumbers.Close);
            case "The Open Button Within The Hot And Cold Numbers Panel In The Game Table" -> EventHandler.click(XPath.GameTable.HotColdNumbers.Open);
            // ? Hot And Cold Numbers Panel of the Game Table Page
            case "The Open Information Button Within The Hot And Cold Numbers Panel In The Game Table" -> EventHandler.click(XPath.GameTable.HotColdNumbers.OpenInformation, 1);
            case "The Close Information Button Within The Hot And Cold Numbers Panel In The Game Table" -> EventHandler.click(XPath.GameTable.HotColdNumbers.CloseInformation, 1);
            ...
            case "The Other Table Within The Jump Table Window In The Game Table" -> EventHandler.click(XPath.GameTable.JumpTable.getTableCard("Table " + Helper.getLastChar(Variables.tableName)));
            case "The Other Product Within The Jump Table Window In The Game Table" -> EventHandler.click(XPath.GameTable.JumpTable.TabMenu.Baccarat, 1);
            case "The Other Product Table Within The Jump Table Window In The Game Table" -> EventHandler.click(XPath.GameTable.JumpTable.getTableCard("Table " + Helper.getLastChar(Variables.tableName)));
